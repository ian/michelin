...
const getBookColors = (country: Country, book: Book): string => {
  ...
  const modernColors = cn(
    ...
    collected
      ...
      : " border-2 border-dashed border-opacity-50 bg-opacity-10 border-red-300 text-[#C1002C]"
  );
    ...
    case "benelux":
      if (year <= 1958) {
        return cn(
          ...
          collected
            ? "text-black"
            : "border-2 border-dashed border-opacity-50 bg-opacity-10 text-countries-benelux"
        );
      }
      break;
    ...
    case "great-britain":
      if (year <= 1930) {
        return cn(
          ...
          collected
            ? "text-black"
            : "border-2 border-dashed border-opacity-50 bg-opacity-10 text-countries-ireland"
        );
      }
      break;
    ...
    case "germany":
      if (year <= 1958) {
        return cn(
          ...
          collected
            ? "text-black"
            : "border-2 border-dashed border-opacity-50 bg-opacity-10 text-countries-germany"
        );
      }
      break;
    ...
    case "portugal":
      if (year <= 1913) {
        return cn(
          ...
          collected
            ? "text-black"
            : "border-2 border-dashed border-opacity-50 bg-opacity-10 text-countries-portugal"
        );
      }
      break;
    ...
    case "spain":
      if (year <= 1958) {
        return cn(
          ...
          collected
            ? "text-black"
            : "border-2 border-dashed border-opacity-50 bg-opacity-10 text-countries-spain"
        );
      }
      break;
    ...
    case "switzerland":
      if (year < 1932) {
        return cn(
          ...
          collected
            ? "text-black"
            : "border-2 border-dashed border-opacity-50 bg-opacity-10 text-countries-switzerland"
        );
      }
      break;
